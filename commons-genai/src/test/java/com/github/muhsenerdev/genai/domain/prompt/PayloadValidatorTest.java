...
class PayloadValidatorTest {
  ...
  private PayloadBlueprintFactory factory = TestBeans.payloadBlueprintFactory();

  private static final String simpleSchemaString = """
      {
        "type": "object",
        "properties": {
  ...
  @BeforeEach
  void setUp() {
    blueprint = factory.create(simpleSchemaString);
